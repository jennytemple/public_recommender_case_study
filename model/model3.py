...
if __name__ == "__main__":
    ...
    pr = gl.recommender.util.compare_models(test, [rec_eng_32, rec_eng_128, rec_eng_32_sf, rec_eng_128_sf], model_names=['128 no side features', '32 no side features', '32 side features', '128 side features'], metric='precision_recall')
